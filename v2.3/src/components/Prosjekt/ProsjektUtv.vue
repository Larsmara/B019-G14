    ...
    <div class="container pt-4">
        ...
        <div class="row">
            <div class="col text-center pt-3">
                ...
                <span class="ml-4"  v-b-tooltip.hover title="Her kan du finne inspirasjon til hvordan du kan skrive prosjektforslaget ditt"><i class="far fa-question-circle"></i></span>
