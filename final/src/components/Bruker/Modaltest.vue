<template>
<div>
    <b-nav-item id="show-btn" @click="showModal(0)" class="model-dialog">Logg inn</b-nav-item>
    <b-nav-item id="show-btn" @click="showModal(1)" class="model-dialog">Ny bruker</b-nav-item>

     <b-modal centered hide-footer id="modal-multi-3" ref="my-modal" title="Smart City Halden" no-stacking>
        ...
        <b-tab title="Logg inn" active>
            ...
            <div class="knapper mt-2">
                <button v-b-modal.modal-multi-4 class="btn btn-link" style="color: rgb(0,114,187)">Glemt passord?</button>
            </div>
        </b-tab>
    ...
    <b-modal centered hide-footer id="modal-multi-4" ref="my-modal2" title="Glemt passord?">
        <app-feil v-if="feil" :text="feil.message"></app-feil>
        <app-suksess v-if="suksess" :text="suksess.message"></app-suksess>
