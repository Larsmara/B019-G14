      ...
      <div class="table-responsive">
        <b-media vertical-align="center" class="border p-3 my-3 shadow-sm bg-white" v-for="(project, index) in prosjekt" :key="project.id">
            ...
            <div class="btn-group pt-2" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'produksjon', true)" v-if="!project.synlig">Synlig</button>
            </div>
            <div class="btn-group pt-2" role="group">
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'eksternt', false)">Eksterne</button>
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'utvalgt', false)">Utvalgt</button>
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'utvalgt', false)">Vis prosjekt</button>
            </div>
            <div class="btn-group pt-2" role="group">
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'skole', false)">Skole</button>
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'teknisk', false)">Teknisk</button>
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'helse', false)">Helse</button>
            </div>
        </b-media>
      </div>
    </div>
