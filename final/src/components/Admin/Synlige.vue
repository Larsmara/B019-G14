<template>
    <div>
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Dashboard - Prosjekter som vises til alle brukere under produksjon</h1>
        </div>
      ...
      <div class="table-responsive">
        <b-media vertical-align="center" class="border p-3 my-3 shadow-sm bg-white" v-for="(project, index) in prosjekt" :key="project.id">
            ...
            <div class="btn-group pt-2" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn hk-outline-btn" @click="oppdaterProsjekt(project, index, 'produksjon', false)">Fjern synlighet</button>
            </div>
