        ...
        <div class="container-fluid w-75">
          <div class="row justify-content-between align-items-center py-5">
              ...
              <div class="col-lg-4 order-sm-1 order-lg-2 mb-3">
                  ...
                  <router-link to="/ny-idé" tag="button" class="btn hk-btn btn-lg">Send Idé</router-link>
                  </span>
                  <span v-else>
                    <router-link to="/ny-idé" tag="button" class="btn hk-btn btn-lg">Logg inn for og kunne sende idé</router-link>
                  </span>
              </div>
